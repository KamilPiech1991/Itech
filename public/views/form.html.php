...
<h2>Wypełnij zgłoszenie online :</h2>
...
<form id="rma-form" role="form" method="POST">
	...
	<div class="row" id="client-hardware">
		...
		<div class="">
			...
			<legend class="text-center" id="client-legend">
				<h3>
					Zgłoszenie do naprawy przez klienta
				</h3>
			</legend>

			<div class="row" id="client-new">
				...
				<div class="text-center">
					<h4 class="mt-5 mb-5"> Jezeli potrzebujesz naprawę na firmę uzupełnij pole nip i firmy:</h4>
				</div>
